    ...
    <div class="container ">
        ...
        <div class="row content">
            <div class="col-lg-6">
                ...
                <p class="sv">Ni hittar oss på andra vånningen i idrottshallen vid BTH. Ingång på kortsidan.</p>
            ...
            <div class="col-lg-6">
                ...
                <p class="sv">Det går också att nå oss på <b>kontakt@karlskronabergsport.se</b> för generella frågor, och <b>kurser@karslrkonabergsport.se</b> om du vill ha information om någon av våra barngrupper eller övriga kurser.</p>
                ...
                <p class="en hidden">You can also reach us on <b>kontakt@karlskronabergsport.se</b> for general questions, and <b>kurser@karslrkonabergsport.se</b> if you want to have information about our youth groups or other courses.</p>
            </div>
